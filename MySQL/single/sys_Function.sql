...
CREATE TABLE `Function` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8 COMMENT='远程函数(必须)\n强制在启动时校验所有demo是否能正常运行通过';
...
-- Dump completed on 2021-01-18  0:35:35
