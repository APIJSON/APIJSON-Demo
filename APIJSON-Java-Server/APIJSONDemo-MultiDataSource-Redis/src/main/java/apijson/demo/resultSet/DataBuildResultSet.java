 ...
 *
 */
public class DataBuildResultSet implements ResultSet {
	private int index = -1;
    ...
    public DataBuildResultSet(Statement statement, final List<String> headers, final List<List<Object>> lines) {
        this.rows = lines;
        this.headers = headers;
        metaData = new DataBuildResultSetMetaDataBase(headers);
    }
