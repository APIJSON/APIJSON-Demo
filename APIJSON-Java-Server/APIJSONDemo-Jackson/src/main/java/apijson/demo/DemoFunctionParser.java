...
import apijson.jackson.APIJSONFunctionParser;
...
public class DemoFunctionParser extends APIJSONFunctionParser<Long> {
	...
	public DemoFunctionParser(RequestMethod method, String tag, int version, Map<String, Object> curObj, HttpSession session) {
