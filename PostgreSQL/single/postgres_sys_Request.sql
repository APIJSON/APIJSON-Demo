...
INSERT INTO sys."Request" (id, version, method, tag, structure, detail, date) VALUES (38, 2, 'POST', 'TestRecord', '{"INSERT": {"@role": "OWNER"}, "DISALLOW": "id", "NECESSARY": "userId,documentId,response"}', null, '2018-06-16 23:44:36.000000');
INSERT INTO sys."Request" (id, version, method, tag, structure, detail, date) VALUES (36, 2, 'PUT', 'Document', '{"INSERT": {"@role": "OWNER"}, "DISALLOW": "userId", "NECESSARY": "id"}', null, '2017-11-26 08:35:15.000000');
